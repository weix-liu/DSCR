...
if __name__ == '__main__':
    ...
    from model.faster_rcnn.vgg16_DSCR_DWPA import vgg16
    from model.faster_rcnn.resnet_DSCR_DWPA import resnet
    ...
    for i in range(num_images):
        ...
        rois_label, feat_vis_before, feat_vis_after = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, im_data_target=False, tgt_im_info=None, tgt_gt_boxes=None, tgt_num_boxes=None,target=True)
